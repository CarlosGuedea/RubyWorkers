...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference("Worker.count") do
      post workers_url, params: { worker: { nombre: @worker.nombre, salario: @worker.salario } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { nombre: @worker.nombre, salario: @worker.salario } }
